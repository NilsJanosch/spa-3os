        ...
        if (!d(" 0o1") || !d("0b1") || d("+0x1")) {
            d = function(t) {
                var n = arguments.length < 1 ? 0 : t
                  , e = this;
                return e instanceof d && (m ? s((function() {
                    y.valueOf.call(e)
                }
                )) : i(e) != h) ? u(new v(b(n)), e, d) : b(n)
            }
            ;
            for (var x, _ = e(31) ? a(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), w = 0; _.length > w; w++)
                o(v, x = _[w]) && !o(d, x) && l(d, x, f(v, x));
            d.prototype = y,
            y.constructor = d,
            e(42)(r, h, d)
        }
    ...
    232: function(t, n, e) {
        ...
        , function(t, n, e) {
            ...
            var L, D = function() {
                ...
                u([A], t.prototype, "autoRender", void 0),
            ...
            var U = function() {
              ...
              , q = function() {
                ...
                ,
                u([N(300)], t.prototype, "autoHideOnIdle", null),
                t
            }()
              , J = new WeakMap;
            function K(t) {
            ...
            function rt(t) {
                ...
                function p(t) {
                    return F(t, [a.element, a.thumb.element]) ? Q.X : F(t, [f.element, f.thumb.element]) ? Q.Y : void 0
                }
            ...
            function ut(t) {
                var n, e = /Android/.test(navigator.userAgent) ? 3 : 2, r = t.options.delegateTo || t.containerEl, o = new X, i = R(t), u = 0;
            ...
            var st = {
              ...
              , pt = function() {
                ...
                t.prototype.destroy = function() {
                    ...
                    this.options.autoRender && cancelAnimationFrame(this._renderID),
                ...
                t.prototype._render = function() {
                    ...
                    this.options.autoRender && (this._renderID = requestAnimationFrame(this._render.bind(this)))
                }
                ,
